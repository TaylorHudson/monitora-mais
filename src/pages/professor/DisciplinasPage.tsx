          ...
          <main className="flex-1 p-4 md:p-8 min-h-screen">
            ...
            <Table className="mt-6 bg-white/70 rounded-xl shadow-sm">
                ...
                {disciplinas.map((item, _) => (
                    <TableRow key={item.id} className="hover:bg-primary/3 transition">
                          ...
                          <div className="flex items-center justify-center gap-2">
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogHeader>
                                  ...
                                  Ao deletar a disciplina todos os dados relacionados a ela serão perdidos.
                              ...
                              <AlertDialogFooter>
                                  ...
                                  <AlertDialogAction variant="destructive" size="default"
                                    onClick={() => console.log("Deletar Disciplina")}
                                  >
